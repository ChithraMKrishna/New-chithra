package com.crm.comcast.createContactMarkettingAssignment;
...
public class CreateContactGroupAsMarkettingGroupTest extends BaseClass
{
	
	@Test(groups= {"regressionTest"})
	public void createContactGroupAsMarkettingGroupTest() throws Throwable 
	{
...
/*		//initializing webdriver
		...
		String assignvalue = eLib.ReaddataFrom("Sheet2", 1, 6);
...
//verify contact is created
	...
	/*	if(actual.contains(expected))
		{
			System.out.println("contact is added with assigned to marketting group");
		}
		else
		{
